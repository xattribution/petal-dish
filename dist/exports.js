...
Grip stacks exclude washers, nut thickness and thread engagement. Select actual bolt lengths using your hardware. Four bolts and larger docking pads increase assembly hardware and material; no numerical strength improvement is claimed.
...
3. Bring neighboring panels to the designed seam gap. Install each matching saddle from behind. In revision 2 all four tongues must seat without forcing before the bolts are tightened.
4. Add outer rings from the center outward, using the matching ring saddles and side saddles for each ring.
