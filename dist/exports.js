...
The exposed cap is nominally flush with the adjacent parabolic surface, apart from intentional seams and screw openings. Reinforcement is underneath. Print all revision-5 parts together; earlier rings, keyed hubs and root profiles are incompatible.`:'The legacy hub remains a pressure-clamped sandwich assembly. Staggering is still independently selectable.'}
...
Connectors join two panels within each overlap; three-panel junction plates are not included. Adaptive spacing, when enabled for recessed plates, adds connectors along long seams. Changing segmentation, spacing or staggering requires regenerated matching parts.
